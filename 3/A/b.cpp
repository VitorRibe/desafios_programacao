/*
  Problema: B - Concert Tickets
  
  Existem n ingressos disponíveis, cada um com um determinado preço. Depois, m clientes chegam, um após o outro.
  Cada cliente anuncia o preço máximo que está disposto a pagar por um ingresso e, após isso, 
  ele ganha um ingresso com o preço mais próximo possível que não exceda o preço máximo.
